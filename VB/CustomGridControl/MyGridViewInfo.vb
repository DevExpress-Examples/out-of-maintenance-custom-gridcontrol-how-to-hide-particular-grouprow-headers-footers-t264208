	...
	Public Class MyGridViewInfo
		...
		Protected Overrides Sub CalcRowFooterInfo(ByVal ri As GridRowInfo, ByVal row As GridRow, ByVal nextRow As GridRow)
			...
			Do While n < ri.RowFooters.RowFooterCount
				Dim parentRowVal = View.GetGroupRowValue(View.GetParentRowHandle(footerRowHandle))

				If parentRowVal IsNot Nothing AndAlso parentRowVal.ToString() = String.Empty Then
					startLevel -= 1
					left -= LevelIndent
